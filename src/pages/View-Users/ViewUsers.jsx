...
import { getAllApprovedUsers } from "../../store/action/User";
...
const ViewUsers = () => {
  ...
  useEffect(() => {
    if (searchUserInput.trim() === "") {
      ...
      const filteredResults = approvedUsers.filter((user) =>
        user.name.toLowerCase().includes(searchUserInput.toLowerCase())
      );
      setFilteredUsers(filteredResults);
    }
  }, [approvedUsers, searchUserInput]);
        ...
        <div className="flex justify-between items-center my-10 px-[10px]">
          <div className="flex flex-col gap-2">
            <h2 className="font-bold text-xl text-white">
              Dialwhy <span className="text-green-500">Approved</span> Members
            </h2>
            <p className="text-gray-300">
              This is the list of all the Approved members.
            </p>
          </div>
